 ...
 * @author luisGonzalez
 */
public class Vehiculo1 extends Vehiculo { //clase hija de vehiculos, sirve para definir los valores de las variables que estan en la clase padre
   Scanner scanner = new Scanner(System.in);
   AutoTanque tipoAuto = new AutoTanque(50, 5, 1, 10, .06, 60, 1, 0);
   AutoAvion tipoAuto2 = new AutoAvion(50, 5, 1, 7, .03, 70, 1, 0);
   
   @Override
   protected String inicializarAuto(){      //se inicializan los datos de vehiculo
       System.out.println("Ingrese el nombre que desea darle al vehiculo 1");
       vehiculo = scanner.nextLine();
       return vehiculo;
   }
   
   @Override
   protected void inicializarTipoAuto(){ //se inicializa el tipo de auto que se desea ser ya sea tanque o avion 
       System.out.println("Es momento de definir el tipo de auto que quieres que sea "+vehiculo);
       ...
       switch (definirAuto){
           case 1:
               //metodo Tanque
               //incluyendo la variable vehiculo[0]
           ...
           case 2:
               //metodo avion
               //inclutendo la variable vehiculo[0]
