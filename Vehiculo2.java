...
public class Vehiculo2 extends Vehiculo{
    ...
    protected String inicializarAuto(){
        System.out.println("Ingrese el nombre que desea darle al vehiculo 2");
    ...
    protected void inicializarTipoAuto(){
        System.out.println("Momento de definir el tipo de auto para "+vehiculo);
